        ...
        <div class="productBox">
          ...
          <div class="merber">
        	 ...
        	 <div class="AllPrice" v-if="getNowCartList.length"> 
            	     ...
            	     <h3 v-if="!isMeber">共计:{{getAllPrice}}</h3> 
                   <h3  v-if="isMeber">共计: <span>{{getAllPrice}}</span> {{ countPrice}}</h3> 
        ...
        ClearAll(){
            ...
            if(key){
              ...
              this.getNowCartList.forEach((item,index) =>{
               ...
               console.log(this.getNowCartList,this.$store.state.getCart)
